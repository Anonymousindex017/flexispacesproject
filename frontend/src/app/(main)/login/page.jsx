...
const loginValidationSchema = Yup.object().shape({
    email: Yup.string().email('Invalid Email').required('Oh pagalet Sahi Vala Email Likho !'),
    password : Yup.string().required('Eh Password Galat Hai, Password Yaad Nahi Kya ?'),
});
